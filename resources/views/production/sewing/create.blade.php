...
@section('title', 'Produksi • Sewing • Batch Baru')
...
@section('content')
    <div class="sewing-page container-fluid">
        <div class="mb-3">
            <a href="{{ route('sewing.index') }}" class="btn btn-sm btn-outline-secondary">
                &larr; Kembali
            </a>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-lg-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="small-label mb-2">WIP Cutting</div>
                        ...
                        <div class="mb-2">
                            <div class="small-label">Batch Cutting Asal</div>
            ...
            {{-- RIGHT: FORM BATCH SEWING --}}
            <div class="col-12 col-lg-8">
                <form action="{{ route('sewing.store', $wip->id) }}" method="post">
                    @csrf

                    <div class="card">
                        <div class="card-body">
                            <h2 class="h5 mb-3">Batch Sewing Baru</h2>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-6 col-md-4">
                                    <label class="form-label small-label d-block">Operator Jahit</label>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-6 col-md-4">
                                    <label class="form-label small-label d-block">Qty yang dijahit</label>
                                    <input type="number" name="qty_to_sew"
                                        value="{{ old('qty_to_sew', (int) $wip->qty) }}" class="form-control mono"
                                ...
                                <div class="col-6 col-md-4">
                                    <label class="form-label small-label d-block">Qty hasil jahit (OK)</label>
                                    <input type="number" name="output_qty"
                                        value="{{ old('output_qty', (int) $wip->qty) }}" class="form-control mono"
                            ...
                            <div class="text-muted small mt-2">
                                Setelah disimpan:
                                <ul class="mb-0">
                                    <li>Stok WIP cutting untuk item ini akan berkurang.</li>
                                    <li>Dibuat batch produksi dengan proses <strong>sewing</strong>.</li>
                                    <li>Dibuat stok WIP baru dengan stage <strong>sewing</strong>.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
